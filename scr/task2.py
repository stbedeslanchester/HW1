...
@summary: Implementation to solve problem two in homework task one.
'''
class task2:
    def __init__(self):
        """
        Constructor for the class "task2".
        """
        self.main()
    ...
    def main(self):
        ...
        print("{0} + {1} + {2} + {3} is {4}".format(num_1, num_2, num_3, num_4, num_1 + num_2 + num_3 + num_4))
